...
description: Implements Manus-style file-based planning to organise and track progress on complex tasks. Creates task_plan.md, findings.md, and progress.md. Use when asked to plan out, break down, or organise a multi-step project, research task, or any work requiring 5+ tool calls. Supports automatic session recovery after /clear.
user-invocable: true
...
Work like Manus: Use persistent markdown files as your "working memory on disc."
...
- Anything requiring organisation
...
- `scripts/init-session.sh` — Initialise all planning files
...
When the planning session is complete (task_plan.md, findings.md, progress.md written), output exactly:

> Planning files written. Run `/to-prd` next to synthesise a PRD?
